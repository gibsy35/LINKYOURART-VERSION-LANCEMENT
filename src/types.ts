...
export const CONTRACTS: Contract[] = [
  {
    ...
    status: 'LIVE',
    description: 'A high-frequency algorithmic art generation system. Revenue shares are distributed based on system performance milestones. Currently experiencing plateauing demand and technical debt.',
    totalUnits: 10000,
    availableUnits: 1250,
    ...
    milestones: [
      { id: '1', label: 'System V4 Launch', date: '2026-06', status: 'COMPLETED', priceImpact: 15 },
    ...
    scoreAlgo: 880,
    scoreLYA: 900,
    professionalValidator: 'WARNER_MUSIC_HUB_0x1',
  ...
  },
  {
    ...
    status: 'RISK',
    description: 'Monolithic digital structures. Each unit represents a fractional revenue share. Currently seeing severe volatility due to virtual land lease adjustments and regulatory scrutiny.',
    totalUnits: 5000,
    availableUnits: 450,
  ...
  },
  {
    ...
    status: 'LIQUIDATION',
    description: 'A vibrant slice of the Meta_Urban sprawl. Revenue shares are currently frozen and entering liquidation protocol due to failed governance audits and massive infrastructure debt.',
    totalUnits: 3000,
    availableUnits: 0,
  ...
  },
  {
    ...
    status: 'RISK',
    description: 'A collection of physical masterpieces tokenized for fractional ownership. Currently experiencing a deep market correction, high storage costs, and a liquidity crunch in the fine art sector.',
    totalUnits: 24000,
    availableUnits: 1200,
  ...
  },
  {
    ...
    status: 'LIQUIDATION',
    description: 'A unique digital anomaly. Recent engine failures and protocol forks have led to a critical decrease in demand and total loss of node synchronization.',
    totalUnits: 1500,
    availableUnits: 85,
