...
export const BreakingNewsTicker: React.FC<BreakingNewsTickerProps> = ({ items, onItemClick }) => {
  ...
  const defaultItems: NewsTickerItem[] = [
    { label: t('Breaking News', 'Flash Info'), content: t('LYA v2.5.0 — Mise à jour réussie', 'LYA v2.5.0 — Mise à jour réussie'), type: 'DANGER', icon: <div className="w-1.5 h-1.5 bg-red-500/50 rounded-full animate-pulse shadow-[0_0_8px_rgba(239,68,68,0.4)]" /> },
    ...
    { label: t('New Listing', 'Nouvelle Inscription'), content: t('NEON_GENESIS Project certified — LYA Score: 892/1000', 'Projet NEON_GENESIS certifié — Score LYA : 892/1000'), type: 'INFO' },
