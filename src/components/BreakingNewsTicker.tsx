...
export const BreakingNewsTicker: React.FC<BreakingNewsTickerProps> = ({ items, onItemClick }) => {
  ...
  const defaultItems: NewsTickerItem[] = [
    { label: t('Breaking News', 'Flash Info'), content: t('LYA v2.5.0 — Mise à jour réussie', 'LYA v2.5.0 — Mise à jour réussie'), type: 'DANGER', icon: <div className="w-1.5 h-1.5 bg-red-500/50 rounded-full animate-pulse" /> },
