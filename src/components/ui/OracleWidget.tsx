    ...
    <div className="bg-surface-high/40 backdrop-blur-xl border border-white/5 p-6 rounded-2xl shadow-2xl relative overflow-hidden group hover:border-primary-cyan/30 transition-all duration-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div className="bg-surface-dim/80 border border-white/5 p-3 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-on-surface-variant/60">{t('ACTIVE_HUBS', 'HUBS_ACTIFS')}</span>
          </div>
        ...
        <div className="bg-surface-dim/80 border border-white/5 p-3 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-on-surface-variant/60">{t('LATENCY_MS', 'LATENCE_MS')}</span>
          </div>
      ...
      <div className="mt-6 pt-6 border-t border-white/5 flex items-center justify-between">
        ...
        {onAction ? (
          <button 
            onClick={onAction}
            className="flex items-center gap-2 text-xs font-black text-primary-cyan uppercase tracking-widest hover:text-white transition-colors"
          >
