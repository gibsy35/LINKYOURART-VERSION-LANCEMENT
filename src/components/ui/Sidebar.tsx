        ...
        {!isCollapsed && (
          ...
          >
            ...
            <div className="flex flex-col min-w-0 flex-1">
              <span className="text-white font-black tracking-tight text-2xl leading-[0.7] truncate uppercase">LINK<span style={{ letterSpacing: '0.16em', marginRight: '0.02em' }}>Y</span>OURART</span>
