...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const menuItems = [
    ...
    { id: 'REGISTRY', icon: BookOpen, label: t('LYA REGISTRY', 'REGISTRE LYA'), category: t('PROTOCOL', 'PROTOCOLE') },
    { id: 'LINK_ART', icon: Link2, label: t('THE PROTOCOL', 'LE PROTOCOLE'), category: t('SYSTEM', 'SYSTÈME') },
