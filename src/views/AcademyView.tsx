      ...
      <section className="px-6 mt-16 sm:mt-24 mb-16">
        <div className="bg-surface-low/30 border border-white/5 rounded-2xl p-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <button 
              onClick={() => onNotify(t('ACCESSING RESOURCE ARCHIVE...', 'ACCÈS À L\'ARCHIVE DES RESSOURCES...'))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { title: t('Protocol Whitepaper v2.5', 'Livre Blanc du Protocole v2.5'), type: 'PDF', icon: <FileText /> },
