        ...
        <div className="overflow-x-auto scrollbar-hide -mx-6 px-6 sm:mx-0 sm:px-0">
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
            {[
              ...
              { label: t('Market Sentiment', 'Sentiment du Marché'), value: marketSentiment.label, trend: `${marketSentiment.value}%`, color: 'border-accent-gold', icon: <ActivityIcon size={16} />, tooltip: t('Real-time analysis of partenaire créatif confidence.', 'Analyse en temps réel de la confiance des mécènes.') }
            ].map((stat, i) => (
