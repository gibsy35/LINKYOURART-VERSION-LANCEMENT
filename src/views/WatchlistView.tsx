        ...
        <>
          <div className={viewMode === 'mosaic' ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" : "flex flex-col gap-4"}>
            ...
            {!isPro && watchlistedContracts.length < 15 && viewMode === 'mosaic' && (
              <div className="border border-dashed border-white/10 rounded-sm p-8 flex flex-col items-center justify-center text-center opacity-30 hover:opacity-100 transition-opacity animate-pulse group cursor-pointer" onClick={() => onViewChange?.('EXCHANGE')}>
