  ...
  return (
    <div className="space-y-12 pb-24 relative min-h-screen">
      ...
      {comparisonList.length > 0 && (
        <div className="relative z-20 -mt-32 mb-12 flex items-end justify-end">
          <button 
            onClick={() => {
          ...
          <div className="p-10 bg-surface-dim border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden mt-20">
             ...
             <div className="flex items-center gap-8 relative z-10">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-on-surface-variant uppercase tracking-[0.3em] opacity-40 max-w-2xl leading-relaxed font-bold text-justify">
