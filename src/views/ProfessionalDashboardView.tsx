...
export const ProfessionalDashboardView: React.FC<{user:UserProfile|null;onNotify:(msg:string)=>void;onViewChange:(v:any)=>void;onSelectContract?:(c:any)=>void}> = ({user,onNotify,onViewChange,onSelectContract}) => {
  ...
  return (
    <div className="space-y-6 pb-12">
      <PageHeader titleWhite={<span style={{ textTransform: 'uppercase' }}>{T('ESPACE','PRO')}</span>} titleAccent={T('PROFESSIONNEL','SPACE')} description={T('Expertise institutionnelle pour accompagner l\'excellence artistique','Institutional expertise to support artistic excellence')} accentColor="text-primary-cyan" category="PROFESSIONAL"/>
