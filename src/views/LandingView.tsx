              ...
              <div className="lg:col-span-7 space-y-10 relative z-20">
                ...
                >
                  ...
                  <p className="text-white/80 text-lg md:text-xl xl:text-[22px] font-medium leading-relaxed mb-10 max-w-3xl text-justify">
                    {t(
                      "Born in 2006 as one of the world's first networking hubs for creative talent, LinkYourArt enters a new era on its 20th anniversary. Founded by Jean-Baptiste Lequime, the platform has always held one conviction: creativity deserves its own economy. Music, film, fashion, gaming, design, architecture, performing arts — every creative project carries real value, for too long ignored by traditional circuits. LinkYourArt is the first worldwide protocol that transforms this value into living, certified rights. Indexed via the proprietary unit LYA/1000, these rights are objectively evaluated, continuously available and inscribed in a certified public registry — transparent, secure, and accessible to all.",
                      "Née en 2006 comme l'un des premiers hubs mondiaux de mise en relation pour les talents créatifs, LinkYourArt entre aujourd'hui dans une nouvelle ère à l'occasion de ses 20 ans. Fondée par Jean-Baptiste Lequime, la plateforme a toujours poursuivi une seule conviction : la création mérite sa propre économie. Musique, cinéma, mode, jeux vidéo, design, architecture, arts de la scène — chaque projet créatif porte une valeur réelle, trop longtemps ignorée par les circuits traditionnels. LinkYourArt est le premier protocole mondial qui transforme cette valeur en droits vivants et certifiés. Indexés selon l'unité propriétaire LYA/1000, ces droits sont évalués objectivement, disponibles en continu et inscrits dans un registre public certifié — transparent, sécurisé, accessible à tous."
                    )}
                  </p>
                </motion.div>
