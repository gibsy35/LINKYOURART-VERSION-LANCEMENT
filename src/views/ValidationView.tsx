...
export const ValidationView: React.FC<{ 
  ...
  return (
    <div className="space-y-8 pb-12">
        ...
        {rejectingId && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-surface-dim/90 backdrop-blur-xl">
            ...
            >
              ...
              <p className="text-sm text-on-surface-variant opacity-70 mb-6 font-medium text-justify">
      ...
      <PageHeader 
        titleWhite={t('Administrative', 'Services')}
        titleAccent={t('Services', 'Administratifs')}
        description={t('Review and certify high-value creative contracts. Every validation step is recorded on the LYA Immutable Registry.', 'Examinez et certifiez les contrats créatifs de haute valeur. Chaque étape de validation est enregistrée sur le registre immuable LYA.')}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-surface-low/40 backdrop-blur-xl border border-white/5 p-8 rounded-xl shadow-2xl group hover:border-primary-cyan/30 transition-all">
          ...
          <p className="text-[10px] text-on-surface-variant leading-relaxed uppercase tracking-[0.2em] font-bold opacity-70 group-hover:opacity-100 transition-opacity text-justify">
      ...
      <div className="pt-24 border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { title: t('Registry Audit', 'Audit du Registre'), icon: <Database size={24} />, color: 'primary-cyan' },
