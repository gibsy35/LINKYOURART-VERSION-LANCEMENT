  ...
  return (
    <div className="term-root" ref={rootRef}>
      <style>{`
        ...
        .term-header.is-scrolled{ background:rgba(11,14,20,0.85); backdrop-filter:blur(14px); -webkit-backdrop-filter:blur(14px); border-bottom:1px solid rgba(255,255,255,0.08); }
      ...
      <section className="term-pillars" id="pillars" style={{ scrollMarginTop: 80 }}>
        <div className="term-wrap">
          ...
          <h2 className="term-reveal" style={{ fontWeight: 700, fontSize: 'clamp(24px,3vw,34px)', marginBottom: 12 }}>
