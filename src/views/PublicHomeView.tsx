      ...
      <section className="term-pricing" id="pricing" style={{ scrollMarginTop: 80 }}>
        <div className="term-wrap">
          ...
          <div className="term-price-grid">
            ...
            <div className="term-price grey term-reveal"><div><div className="name">Pro Starter</div><div className="amount">79€<span style={{ fontSize: 13 }}>{t('/mois', '/mo')}</span></div><div className="desc">{t('Volume de soumissions élevé, accès complet au registre, file prioritaire', 'High submission volume, full registry access, priority queue')}</div></div></div>
