  ...
  return (
    <div className="term-root" ref={rootRef}>
      <style>{`
        ...
        .term-header.is-scrolled{ background:rgba(11,14,20,0.65); backdrop-filter:blur(14px); -webkit-backdrop-filter:blur(14px); border-bottom:1px solid rgba(255,255,255,0.08); }
