      ...
      <header className="pt-2">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
          <div className="flex-1">
            ...
            <p className="border-l-2 border-primary-cyan pl-6 text-on-surface-variant max-w-2xl text-sm md:text-base leading-relaxed opacity-80 font-medium text-justify">
