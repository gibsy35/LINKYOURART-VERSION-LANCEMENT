...
function buildValidatorAlertEmail({ userName, userEmail, userId, entityName, registrationNumber, authority, sector }) {
  ...
  '<span style="float:right;font-size:9px;font-weight:900;color:#34d399;text-transform:uppercase;letter-spacing:0.15em;border:1px solid rgba(52,211,153,0.3);padding:4px 10px;border-radius:20px">Validator</span>' +
  '</td></tr>' +
  '<tr><td style="background:linear-gradient(90deg,#34d399,#00d4ff,#a78bfa);height:3px;font-size:0">&nbsp;</td></tr>' +
