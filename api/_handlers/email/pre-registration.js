    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:rgba(0,212,232,0.04);border:1px solid rgba(0,212,232,0.15);border-radius:14px;margin-bottom:28px;">
      <tr><td style="padding:24px 28px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          ...
          <tr><td style="padding:7px 0;"><span style="font-size:11px;color:#8B94A3;letter-spacing:0.1em;text-transform:uppercase;">Statut</span></td><td style="padding:7px 0;text-align:right;"><span style="font-size:11px;font-weight:900;color:#FFD700;background:rgba(255,215,0,0.1);border:1px solid rgba(255,215,0,0.3);border-radius:20px;padding:3px 10px;letter-spacing:0.1em;">${isFR ? '⏳ EN COURS D\'EXAMEN' : '⏳ UNDER REVIEW'}</span></td></tr>
        </table>
      </td></tr>
    </table>
