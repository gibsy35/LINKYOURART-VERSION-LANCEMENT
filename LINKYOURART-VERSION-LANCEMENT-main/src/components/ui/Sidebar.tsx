...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const menuItems = [
    ...
    { id: 'DASHBOARD', icon: LayoutDashboard, label: t('common.dashboard', 'DASHBOARD'), category: t('INDEX', 'INDEX') },
    { id: 'EXCHANGE', icon: ArrowLeftRight, label: t('sidebar.exchange', 'CREATIVE MARKET'), category: t('DEVELOPMENT', 'DÉVELOPPEMENT') },
    { id: 'SWIPE', icon: Target, label: t('sidebar.swipe', 'DÉCOUVERTE LYA'), category: t('DEVELOPMENT', 'DÉVELOPPEMENT') },
    { id: 'COMPARE', icon: Calculator, label: t('sidebar.compare', 'COMPARATEUR'), category: t('INDEX', 'INDEX') },
    { id: 'WATCHLIST', icon: CheckCircle, label: t('sidebar.watchlist', 'FAVORIS'), category: t('INDEX', 'INDEX'), count: watchlist.length },
    { id: 'VALIDATION', icon: ShieldCheck, label: t('sidebar.validation', 'INDEXATION'), category: t('PROTOCOL', 'PROTOCOLE') },
    { id: 'HOLDINGS', icon: Briefcase, label: t('sidebar.holdings', 'COLLECTION'), category: t('VAULT', 'COFFRE') },
    { id: 'REGISTRY', icon: BookOpen, label: t('sidebar.registry', 'REGISTRE'), category: t('PROTOCOL', 'PROTOCOLE') },
    { id: 'LINK_ART', icon: Link2, label: t('sidebar.link_art', 'LE PROTOCOLE'), category: t('SYSTEM', 'SYSTÈME') },
    { id: 'ABOUT', icon: Target, label: t('sidebar.about', 'DÉCOUVRIR LYA'), category: t('SYSTEM', 'SYSTÈME') },
    { id: 'SOCIAL_FEED', icon: Users, label: t('sidebar.community', 'SOCIAL'), category: t('COMMUNITY', 'COMMUNAUTÉ') },
    { id: 'LOUNGE', icon: Coffee, label: t('sidebar.lounge', 'SALON'), category: t('COMMUNITY', 'COMMUNAUTÉ') },
    { id: 'ACADEMY', icon: Globe, label: t('sidebar.academy', 'ACADÉMIE'), category: t('RESOURCES', 'RESSOURCES') },
    { id: 'OUR_MODEL', icon: Fingerprint, label: t('sidebar.our_model', 'NOTRE MODÈLE'), category: t('SYSTEM', 'SYSTÈME') },
    { id: 'FAQ', icon: MessageSquare, label: t('sidebar.faq', 'FAQ'), category: t('RESOURCES', 'RESSOURCES') },
    { id: 'LEGAL_MENTIONS', icon: FileText, label: t('sidebar.mentions', 'MENTIONS LÉGALES'), category: t('RESOURCES', 'RESSOURCES') },
  ];

  if (user?.role === UserRole.ADMIN) {
    menuItems.push({ id: 'ADMIN_PANEL', icon: Shield, label: t('ADMIN HUB', 'ADMIN HUB'), category: t('SYSTEM', 'SYSTÈME') });
  }
          ...
          >
            ...
            <div className="flex flex-col min-w-0 flex-1">
              ...
              <span className="text-[10px] text-primary-cyan font-black tracking-[0.2em] uppercase mt-2 opacity-60 group-hover:opacity-100 transition-opacity">
                {t('THE CREATIVE TERMINAL', 'LE TERMINAL CRÉATIF')}
              </span>
            </div>
          </motion.div>
        )}
