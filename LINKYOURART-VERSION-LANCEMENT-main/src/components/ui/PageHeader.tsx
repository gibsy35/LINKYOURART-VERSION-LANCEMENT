      ...
      <div className="flex flex-col">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-xl md:text-3xl lg:text-5xl font-bold font-headline tracking-tighter leading-none uppercase flex flex-wrap items-baseline gap-x-2 md:gap-x-4">
          ...
          {description && (
            <div className="flex items-stretch gap-6 md:gap-8 pl-2">
              ...
              <p className="text-white md:text-lg font-semibold uppercase tracking-[0.15em] leading-tight opacity-90 max-w-3xl self-center text-justify">
                {description}
              </p>
            </div>
          )}
