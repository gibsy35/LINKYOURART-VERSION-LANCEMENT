    ...
    MENTIONS: {
      ...
      sections: [
        ...
        },
        {
          ...
          text: t('The LYA ecosystem is powered by a modern and secure technical architecture, ensuring a smooth experience for all creators, investors and professionals worldwide.', 'L\'écosystème LYA est propulsé par une architecture technique moderne et sécurisée, assurant une expérience fluide pour tous les créateurs, investisseurs et professionnels du monde entier.')
        }
      ]
    },
    OUR_MODEL: {
  ...
  return (
    <div className="min-h-screen pb-24 relative overflow-hidden bg-surface-dim">
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-end gap-8 -mt-32 mb-12 relative z-20 px-6 md:px-12">
          <div className="flex flex-wrap gap-4">
            <div className="px-8 py-5 bg-surface-dim/80 border border-white/10 rounded-2xl backdrop-blur-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden group">
              ...
              <div className="text-3xl font-black text-white italic tracking-tighter uppercase">{t('Active & Secure', 'ACTIF & SÉCURISÉ')}</div>
            </div>
            <div className="px-8 py-5 bg-surface-dim/80 border border-white/10 rounded-2xl backdrop-blur-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                    ...
                    >
                      ...
                      <div className="relative glass-panel p-10 rounded-[2.5rem] border-white/10 bg-surface-dim/40 hover:bg-surface-dim/60 hover:border-primary-cyan/30 transition-all duration-500 shadow-2xl h-full flex flex-col">
                        <div className="flex gap-6 items-start mb-6">
                          ...
                          <h3 className="text-xl font-black text-white italic tracking-tighter uppercase leading-tight group-hover:text-primary-cyan transition-colors duration-500">
                            {item.q}
                          </h3>
                        </div>
        ...
        {type !== 'FAQ' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-6 md:px-12">
              ...
              >
                ...
                <div className="relative glass-panel p-12 rounded-[3rem] border-white/10 bg-surface-dim/60 hover:bg-surface-dim/80 hover:border-primary-cyan/30 transition-all duration-500 shadow-[0_30px_60px_rgba(0,0,0,0.4)] flex flex-col h-full">
                  ...
                  <div className="flex items-center gap-6 mb-8 relative z-10">
                    ...
                    <h2 className="text-2xl font-black text-white italic tracking-tighter uppercase leading-none group-hover:text-primary-cyan transition-colors">
                      {section.title}
                    </h2>
                  </div>
        ...
        <footer className="mt-20 pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-8 px-6 md:px-12">
