  ...
  if (user?.role !== UserRole.ADMIN && !user?.isPro) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center">
        ...
        <button 
          onClick={() => onNotify(t('Redirecting to Pricing...', 'Redirection vers les Tarifs...'))}
  ...
  return (
    <div className="space-y-12 pb-24 relative min-h-screen">
      ...
      <div className="mb-12 flex items-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300">
        ...
        <span className="text-[10px] font-bold text-accent-gold tracking-[0.5em] uppercase italic">{t('LYA UNITS ARE INDEXED', 'Unités LYA Indexées')}</span>
      ...
      <div className="relative z-20 lg:-mt-24 mb-12">
        <div className="flex flex-col lg:flex-row lg:items-center justify-end gap-6 md:gap-8 px-6 md:px-12">
          <div className="hidden lg:block mr-auto">
            <div className="text-[10px] font-black text-accent-gold uppercase tracking-[0.5em] opacity-40 animate-pulse">{t('LYA UNITS ARE INDEXED', 'Unités LYA Indexées')}</div>
          </div>
                  ...
                  <div className="absolute bottom-0 left-0 p-10 md:p-14 z-20">
                    ...
                    <div className="flex flex-wrap gap-6 mt-8">
                      <div className="flex flex-col">
                        <span className="text-[10px] text-accent-gold font-black uppercase tracking-widest mb-1 opacity-60">{t('Global Volume', 'Volume Global')}</span>
                      ...
                      <div className="flex flex-col border-l border-white/10 pl-6">
                        ...
                        <span className="text-xl font-black text-white italic tracking-tighter uppercase">{t(pulseStats.topSector, pulseStats.topSector)}</span>
                      </div>
                      <div className="flex flex-col border-l border-white/10 pl-6">
                        <span className="text-[10px] text-accent-gold font-black uppercase tracking-widest mb-1 opacity-60">{t('Volatility Index', 'Indice de Volatilité')}</span>
                        <span className="text-xl font-black text-white italic tracking-tighter uppercase text-primary-cyan">{t(pulseStats.volatility, pulseStats.volatility)}</span>
                      </div>
                    </div>
                  </div>

                  <div className="absolute top-10 right-10 flex flex-col items-end gap-2">
                    <div className="text-[10px] text-accent-gold font-black uppercase tracking-widest mb-1 italic">{t('MARKET TREND', 'TENDANCE DU MARCHÉ')}</div>
