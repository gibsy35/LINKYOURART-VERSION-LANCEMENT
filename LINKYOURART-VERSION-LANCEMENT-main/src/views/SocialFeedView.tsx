      ...
      <div className="relative z-10 h-full flex flex-col justify-end p-6 md:p-12 lg:p-16 max-w-[1800px] mx-auto">
        <AnimatePresence mode="popLayout">
          ...
          >
            ...
            <p className="border-l-2 border-primary-cyan pl-4 md:pl-6 text-sm md:text-lg text-white/80 max-w-2xl mb-8 md:mb-10 font-medium leading-relaxed drop-shadow-lg line-clamp-2 text-justify">
