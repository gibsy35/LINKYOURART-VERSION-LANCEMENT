          ...
          <Fragment>
            <div className="flex flex-col lg:flex-row gap-8 items-end justify-between mb-8">
              <div className="flex flex-wrap items-end gap-4 w-full">
                ...
                <div className="space-y-2 min-w-[140px]">
                  <span className="text-[9px] text-on-surface-variant uppercase tracking-[0.3em] font-black opacity-50 px-1">{t('Jurisdiction', 'Juridiction')}</span>
                  <div className="relative">
                    <select 
                      ...
                      className="w-full bg-surface-low/50 backdrop-blur-xl border border-white/10 text-[10px] font-black uppercase tracking-widest py-3 pl-4 pr-10 appearance-none focus:border-primary-cyan focus:ring-1 focus:ring-primary-cyan outline-none transition-all rounded-xl"
                    >
                      <option value="ALL">{t('All Jurisdictions', 'Toutes les Juridictions')}</option>
            ...
            <div className="space-y-8">
              <div className="p-6 bg-white/5 rounded-2xl border border-white/10 relative overflow-hidden">
                ...
                <p className="text-xs text-on-surface-variant leading-relaxed font-medium text-justify">
                  {t('Registry nodes are operating at', 'Les nœuds du registre fonctionnent à')} <span className="text-on-surface font-bold">99.98%</span> {t('efficiency.', 'd\'efficacité.')} 
                  {t('Cross-jurisdictional compliance checks are synchronized with MiCA and SEC standards.', 'Les contrôles de conformité transjuridictionnels sont synchronisés avec les normes MiCA et SEC.')}
                </p>
              </div>
